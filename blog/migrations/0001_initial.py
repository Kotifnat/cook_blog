    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prep_time', models.DateTimeField(default=0, verbose_name='Время подготовки')),
                ('cook_time', models.DateTimeField(default=0, verbose_name='Время готовки')),
                ('ingredients', models.TextField(verbose_name='Ингредиенты')),
                ('direction', models.TextField(verbose_name='Процесс приготовления')),
